    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Spindle agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Spindle to connect to Spindle servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow Spindle to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Spindle to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Spindle to access your camera so you can scan pairing QR codes.",

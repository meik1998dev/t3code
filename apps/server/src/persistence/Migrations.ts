...
import Migration0051 from "./Migrations/051_ThreadTaskPlanLookup.ts";
import Migration0052 from "./Migrations/052_RepairThreadBranchPullRequestColumn.ts";
import Migration0053 from "./Migrations/053_ProjectionThreadsParentThreadId.ts";
import Migration0054 from "./Migrations/054_RepairUpstreamMigrationsAfterFork.ts";
...
const migrationEntries = [
  ...
  [51, "ThreadTaskPlanLookup", Migration0051],
  [52, "RepairThreadBranchPullRequestColumn", Migration0052],
  [53, "ProjectionThreadsParentThreadId", Migration0053],
  [54, "RepairUpstreamMigrationsAfterFork", Migration0054],
] as const;

...
/**
 * The palette Spindle wears with no theme installed, captured from the app's
...
/**
 * The standard Spindle look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Spindle shows without a theme, read from the app's own

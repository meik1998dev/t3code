...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  return (
    <li
      ...
      {...sortableRootProps}
      className={cn(
        "list-none py-0.5 [content-visibility:auto] [contain-intrinsic-size:auto_88px]",
        sortable?.isDragging && "relative z-20",
      )}
    >
      <Tooltip disabled={snoozeMenuOpen || sortable?.isDragging}>
        ...
        >
          <div className="relative z-10 min-h-[var(--sidebar-thread-card-height)] px-[var(--sidebar-row-content-inset)] py-[var(--sidebar-content-inset)]">
            <div className="flex h-5 min-w-0 items-center gap-1.5">
              {draftIndicator}
              <ProjectFavicon
                environmentId={thread.environmentId}
            ...
            <div className="mt-0.5 flex min-w-0 items-center gap-1.5 text-secondary-label text-xs">
              ...
              {thread.branch ? (
                <>
                  ...
                  <span className="min-w-0 flex-1 truncate whitespace-nowrap font-mono text-muted-foreground/40">
                    {thread.branch}
                  </span>
                </>
              ) : (

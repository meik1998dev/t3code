...
Both instances must use the same **CODEX_HOME path**. Spindle prepares the shared
...
Choose the other account from the thread's model picker. Spindle offers compatible

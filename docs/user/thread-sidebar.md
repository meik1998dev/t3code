...
When you change a new thread's project, Spindle stays in the current environment
...
If dragging is unavailable for one environment, update the Spindle server running in that

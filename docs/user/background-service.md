# Running Spindle in the background

On Linux and macOS, Spindle can run as a service for your user so you do not need
...
Linux needs systemd user services. Setup enables lingering so Spindle starts at
...
with sudo; running Spindle as root creates a separate installation and Connect

 ...
 * machine into a Spindle browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Spindle profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Spindle Full Disk Access in System Settings → Privacy & Security, then retry.",

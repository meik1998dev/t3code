  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Spindle prerelease is available for nightly testers."
          : "A new Spindle latest release is available.",
...
).pipe(Command.withDescription("Post a Spindle release announcement to Discord."));
